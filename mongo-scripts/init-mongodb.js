...
const elements = [
  ...
  {
    id: talktracks[12].id, // 34  // why is this talk-track a loner
  ...
  {
    id: uuid.v4(), // 36
    container_id: blocks[10].id, // note: this may not be needed, look into removing
    label: 'notes',
    type: 'notes-field',
    value: ''
  },
  ...
  {
    id: uuid.v4(), // 81
    container_id: blocks[24].id, // note: this may not be needed, look into removing
    label: 'notes',
    type: 'notes-field',
    value: ''
  },
